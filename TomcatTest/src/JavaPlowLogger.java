...
public class JavaPlowLogger extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (writeHTML) {
            ...
            try {
                ...
                out.println("<p>Changed ID: " + request.changeSessionId() + "</p>");
    ...
    public Map<String,String[]> geoData(String ip){
        ...
        File db = new File("C:\\Users\\Kevin Gleason\\IdeaProjects\\TomcatTest\\Geo Data\\GeoLiteCity.dat");
    ...
    public static void main(String args[]) throws IOException{
        ...
        String filein = "C:\\Users\\Kevin Gleason\\IdeaProjects\\TomcatTest\\Geo Data\\GeoLiteCity.dat";
